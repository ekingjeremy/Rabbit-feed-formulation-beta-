...
# ---------------- LOAD INGREDIENTS ----------------
@st.cache_data
def load_ingredients(csv_path="feed_ingredients_nigeria.csv"):
...
st.markdown("""
Optimize your feed for **Rabbits, Poultry, and Cattle** using real Nigerian ingredient prices and nutrient data.
Upload your own ingredient cost data if needed — editable in the app!
""")
